...
import src.utils.utils_ as utils
...
def plot_embedding(args, model, train_loader, cluster_centers, Y_train_clean, Y_train,
                   saver, network='Model', correct=False):
    print('Plot Embedding...')
    # Embeddings
    train_embedding = utils.predict(model, train_loader,args).squeeze()
